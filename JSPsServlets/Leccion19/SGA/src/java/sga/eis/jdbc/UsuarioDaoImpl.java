...
public class UsuarioDaoImpl extends AbstractDAO implements UsuarioDao {
    ...
    public UsuarioPk insert(Usuario dto) throws UsuarioDaoException {
        ...
        // declare variables
        final boolean isConnSupplied = (getUserConn() != null);
        ...
        try {
            ...
            conn = isConnSupplied ? getUserConn() : ResourceManager.getInstance().getBasicDataSource().getConnection();
    ...
    public Usuario[] findByPersona(Integer idPersona) throws UsuarioDaoException {
        return findByDynamicSelect(SQL_SELECT + " WHERE " + getTableName() + ".id_persona = ?", new Object[]{idPersona});
    }
